...
/**
 * The persistent class for the wdpage_restrictions database table.
 * 
 */
@Entity
@Table(name="wdpage_restrictions")
@NamedQuery(name="WdpageRestriction.findAll", query="SELECT w FROM WdpageRestriction w")
public class WdpageRestriction implements Serializable {
