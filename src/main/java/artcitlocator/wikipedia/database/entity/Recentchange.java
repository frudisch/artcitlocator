...
/**
 * The persistent class for the recentchanges database table.
 * 
 */
@Entity
@Table(name="recentchanges")
@NamedQuery(name="Recentchange.findAll", query="SELECT r FROM Recentchange r")
public class Recentchange implements Serializable {
	...
	private byte rcMovedToNs;

	@Column(name="rc_moved_to_title")
	private String rcMovedToTitle;
	...
	public byte getRcMovedToNs() {
		return this.rcMovedToNs;
	}

	public void setRcMovedToNs(byte rcMovedToNs) {
		this.rcMovedToNs = rcMovedToNs;
	}

	public String getRcMovedToTitle() {
		return this.rcMovedToTitle;
	}

	public void setRcMovedToTitle(String rcMovedToTitle) {
		this.rcMovedToTitle = rcMovedToTitle;
	}
