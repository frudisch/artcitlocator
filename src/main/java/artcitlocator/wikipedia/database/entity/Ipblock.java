...
/**
 * The persistent class for the ipblocks database table.
 * 
 */
@Entity
@Table(name="ipblocks")
@NamedQuery(name="Ipblock.findAll", query="SELECT i FROM Ipblock i")
public class Ipblock implements Serializable {
	...
	public String getIpbByText() {
		return this.ipbByText;
	}

	public void setIpbByText(String ipbByText) {
