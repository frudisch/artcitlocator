...
/**
 * The persistent class for the site_stats database table.
 * 
 */
@Entity
@Table(name="site_stats")
@NamedQuery(name="SiteStat.findAll", query="SELECT s FROM SiteStat s")
public class SiteStat implements Serializable {
	...
	@Column(name="ss_admins")
	private int ssAdmins;
	...
	public int getSsAdmins() {
		return this.ssAdmins;
	}

	public void setSsAdmins(int ssAdmins) {
		this.ssAdmins = ssAdmins;
	}
