...
/**
 * The persistent class for the wdarchive database table.
 * 
 */
@Entity
@NamedQuery(name="Wdarchive.findAll", query="SELECT w FROM Wdarchive w")
public class Wdarchive implements Serializable {
	...
	@Column(name="ar_content_format")
	private byte[] arContentFormat;

	@Column(name="ar_content_model")
